"""
Generates mutation data for a variety of percentages, using randomly generated 15-puzzles
"""

from pygame import time
import pygame
from sbp import genetic as gen
...
if __name__ == "__main__":
    ...
    with open("mutatedatamore.csv", "w+") as f:
        ...
        for i in range(0, 20):
            level = Level(length, length*length-1, dist)
            for j in range(4, 20):
